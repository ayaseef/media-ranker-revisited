...
describe Vote do
  ...
  describe "validations" do
    ...
    let (:work1) { Work.new(category: "book", title: "House of Leaves", user_id: users(:dan).id) }
    let (:work2) { Work.new(category: "book", title: "For Whom the Bell Tolls", user_id: users(:dan).id)  }
